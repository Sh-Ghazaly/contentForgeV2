...
if (status === 403) {
  ...
  const modalTypeMap = {
    feature_locked: { type: "feature_locked", title: "Feature Locked" },
    posts_limit_exceeded: { type: "posts_limit", title: "Posts Limit Reached" },
    calendar_limit_exceeded: { type: "calendar_limit", title: "Calendar Limit Reached" },
    brands_limit_exceeded: { type: "brands_limit", title: "Brands Limit Reached" },
  };

  const modalConfig = modalTypeMap[reason] || { type: "general", title: "Access Denied" };
