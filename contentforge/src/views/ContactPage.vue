...
<template>
  <div
    class="min-h-screen theme-surface transition-colors duration-200"
  ...
  >
    ...
    <section class="relative z-10 py-16 sm:py-24 px-4 sm:px-6">
      <!-- Background glow -->
      <div
        class="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[300px] rounded-full bg-blue-600/5 blur-3xl pointer-events-none"
      ></div>
      ...
      <div class="max-w-lg mx-auto">
        ...
        <div class="text-center mb-10">
          <h1
            class="font-display text-3xl sm:text-4xl font-700 theme-text mb-3"
          >
            {{ t("contact.title") }}
        ...
        <div v-if="submitted" class="text-center py-16">
          <div
            class="w-14 h-14 rounded-full bg-green-500/10 border border-green-500/20 flex items-center justify-center mx-auto mb-5 text-xl text-green-400"
          >
            ✓
          </div>
          <h3 class="text-lg font-600 theme-text mb-2">
        ...
        <form v-else @submit.prevent="handleSubmit" class="space-y-4">
          <div class="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              />
              <p v-if="errors.name" class="text-[11px] text-rose-400 mt-1">
            ...
            <div>
              ...
              />
              <p v-if="errors.email" class="text-[11px] text-rose-400 mt-1">
          ...
          <div>
            ...
            >
              <option value="" disabled class="theme-surface">
            ...
            <p v-if="errors.subject" class="text-[11px] text-rose-400 mt-1">
              {{ t("contact.form.subjectError") }}
            </p>
          </div>
          ...
          <div>
            ...
            <div class="flex items-center justify-between mt-1">
              <p v-if="errors.message" class="text-[11px] text-rose-400">
                {{ t("contact.form.messageError") }}
              </p>
              <p class="text-[11px] theme-muted ms-auto">
          ...
          <div
            v-if="submitError"
            class="px-4 py-3 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 text-sm"
          >
          ...
          <p class="text-[11px] theme-muted text-center">
...
async function handleSubmit() {
  ...
  loading.value = true;
  try {
    const res = await fetch("https://content-forge-v2.vercel.app/api/contact", {
      method: "POST",
